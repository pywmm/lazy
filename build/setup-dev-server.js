...
module.exports = function setupDevServer(app, cb) {
  ...
  const clientConfig = require('./webpack.client.config'); // eslint-disable-line global-require
  const serverConfig = require('./webpack.server.config'); // eslint-disable-line global-require

  // modify client config to work with hot middleware
  clientConfig.entry.app = ['webpack-hot-middleware/client?overlay=false', clientConfig.entry.app];
